...
export function IconeAgenda() {
  return (
    <svg className="icone icone-solido" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M7 2a1 1 0 0 1 1 1v1h8V3a1 1 0 1 1 2 0v1h1a2 2 0 0 1 2 2v2H3V6a2 2 0 0 1 2-2h1V3a1 1 0 0 1 1-1zM3 10h18v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-9zm8 2v3H8v2h3v3h2v-3h3v-2h-3v-3h-2z" />
    </svg>
  )
}
